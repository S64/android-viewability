...
public class AppViewabilityObserverBak {
    ...
    private final AppAreaObserverBak.IListener areaListener = new AppAreaObserverBak.IListener() {
        ...
        public void onDisplaySizeChanged(
            ...
            AppViewabilityObserverBak.this.onDisplaySizeChanged(oldDisplaySize, newDisplaySize);
        }
        ...
        public void onWindowRectChanged(
            ...
            AppViewabilityObserverBak.this.onWindowRectChanged(oldWindowRect, newWindowRect);
        }
    ...
    public AppViewabilityObserverBak(
